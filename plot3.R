...
plot(CP1$Date, CP1$Sub_metering_1,type="l",col="black",xlab="",ylab="Energy Sub metering")
lines(CP1$Date, CP1$Sub_metering_2,col="red")
lines(CP1$Date, CP1$Sub_metering_3,col="blue")
